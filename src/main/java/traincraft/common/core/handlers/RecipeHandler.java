...
public class RecipeHandler {
	public static void initBlockRecipes() {
		...
		/* Assembly tables */
		//GameRegistry.addRecipe(new ItemStack(TCBlocksList.assemblyTableI.block, 1), new Object[] { "IPI", "S S", "SPS", Character.valueOf('I'), Item.ingotIron, Character.valueOf('P'), Block.pistonBase, Character.valueOf('S'), Block.stone });
		//GameRegistry.addRecipe(new ItemStack(TCBlocksList.assemblyTableII.block, 1), new Object[] { "GPG", "O O", "OPO", Character.valueOf('G'), Item.ingotGold, Character.valueOf('P'), Block.pistonBase, Character.valueOf('O'), Block.obsidian });
		//GameRegistry.addRecipe(new ItemStack(TCBlocksList.assemblyTableIII.block, 1), new Object[] { "GPG", "DLD", "OPO", Character.valueOf('G'), Item.ingotGold, Character.valueOf('P'), Block.pistonBase, Character.valueOf('D'), Item.diamond, Character.valueOf('L'), Block.glowStone, Character.valueOf('O'), Block.obsidian });
		addDictRecipe(new ItemStack(TCBlocksList.trainWorkbench.block, 1), new Object[] { "###", "IFI", "###", Character.valueOf('#'), "plankWood", Character.valueOf('F'), Blocks.furnace, Character.valueOf('I'), Items.iron_ingot });
		//addDictRecipe(new ItemStack(TCBlocksList.distilIdle.block, 1), new Object[] { "###", "#F#", "###", Character.valueOf('#'), "ingotSteel", Character.valueOf('F'), ItemIDs.firebox.item });

		/* Open Hearth Furnace */
		GameRegistry.addRecipe(new ItemStack(TCBlocksList.openFurnaceIdle.block, 1), new Object[] { "#L#", "#B#", "#I#", Character.valueOf('#'), Blocks.nether_brick, Character.valueOf('L'), Items.lava_bucket, Character.valueOf('B'), Items.bucket, Character.valueOf('I'), Blocks.iron_block });

		/* Lantern */
		//GameRegistry.addRecipe(new ItemStack(TCBlocksList.lantern.block, 4), new Object[] { "III", "PTP", "III", Character.valueOf('I'), Item.ingotIron, Character.valueOf('P'), Block.thinGlass, Character.valueOf('T'),Block.torchWood });
		...
		/*Buffer*/
		//addDictRecipe(new ItemStack(TCBlocksList.stopper.block, 1), new Object[] { "WWW", "I I", "RRR", Character.valueOf('W'), "plankWood", Character.valueOf('R'), Block.rail, Character.valueOf('I'), Item.ingotIron});
		
		GameRegistry.addRecipe(new ItemStack(TCBlocksList.oreTC.block, 1,3), new Object[] { "GXG", Character.valueOf('G'), Blocks.gravel, Character.valueOf('X'), Items.clay_ball});
	...
	public static void initItemRecipes() {
		...
		if (planks != null && planks.size() >= 0) {
			for (ItemStack plank : planks) {
				TrainCraftingManager.instance.addRecipe(new ItemStack(TCBlocksList.trainWorkbench.block, 1), new Object[] { "###", "IFI", "###", Character.valueOf('#'), plank, Character.valueOf('F'), Blocks.furnace, Character.valueOf('I'), Items.iron_ingot });
			}
		}
		...
		/* Assembly tables */
		//TrainCraftingManager.instance.addRecipe(new ItemStack(TCBlocksList.assemblyTableI.block, 1), new Object[] { "IPI", "S S", "SPS", Character.valueOf('I'), Item.ingotIron, Character.valueOf('P'), Block.pistonBase, Character.valueOf('S'), Block.stone });
		//TrainCraftingManager.instance.addRecipe(new ItemStack(TCBlocksList.assemblyTableII.block, 1), new Object[] { "GPG", "O O", "OPO", Character.valueOf('G'), Item.ingotGold, Character.valueOf('P'), Block.pistonBase, Character.valueOf('O'), Block.obsidian });
		//TrainCraftingManager.instance.addRecipe(new ItemStack(TCBlocksList.assemblyTableIII.block, 1), new Object[] { "GPG", "DLD", "OPO", Character.valueOf('G'), Item.ingotGold, Character.valueOf('P'), Block.pistonBase, Character.valueOf('D'), Item.diamond, Character.valueOf('L'), Block.glowStone, Character.valueOf('O'), Block.obsidian });

		/* Open Hearth Furnace */
		TrainCraftingManager.instance.addRecipe(new ItemStack(TCBlocksList.openFurnaceIdle.block, 1), new Object[] { "#L#", "#B#", "#I#", Character.valueOf('#'), Blocks.nether_brick, Character.valueOf('L'), Items.lava_bucket, Character.valueOf('B'), Items.bucket, Character.valueOf('I'), Blocks.iron_block });

		/* Lantern */
		//TrainCraftingManager.instance.addRecipe(new ItemStack(TCBlocksList.lantern.block, 4), new Object[] { "III", "PTP", "III", Character.valueOf('I'), Item.ingotIron, Character.valueOf('P'), Block.thinGlass, Character.valueOf('T'),Block.torchWood });
		...
		/* diesel generator */
		//TrainCraftingManager.instance.addRecipe(new ItemStack(TCBlocksList.generatorDiesel.block, 1), new Object[] { "C  ", "DE ", Character.valueOf('C'), ItemIDs.steelchimney.item, Character.valueOf('D'), ItemIDs.dieselengine.item, Character.valueOf('E'), ItemIDs.electronicCircuit.item });
			...
			for (int i = 0; i < s1.size(); i++) {
				if (steel != null && steel.size() >= 0) {
					for (int t = 0; t < steel.size(); t++) {
						...
						//TrainCraftingManager.instance.addRecipe(new ItemStack(TCBlocksList.distilIdle.block, 1), new Object[] { "###", "#F#", "###", Character.valueOf('#'), steel.get(t), Character.valueOf('F'), ItemIDs.firebox.item });
				...
				if (s2 != null && s2.size() >= 0) {
					for (int j = 0; j < s2.size(); j++) {
						/* Water Wheel */
						//TrainCraftingManager.instance.addRecipe(new ItemStack(TCBlocksList.waterWheel.block, 1), new Object[] { " P ", "PGP", " P ", Character.valueOf('P'), s2.get(j),Character.valueOf('G'), ItemIDs.generator.item});
						/* Wind mill */
						//TrainCraftingManager.instance.addRecipe(new ItemStack(TCBlocksList.windMill.block, 1), new Object[] { " R ", " G ", "B B",Character.valueOf('G'), ItemIDs.generator.item, Character.valueOf('B'), Item.ingotIron, Character.valueOf('R'), ItemIDs.propeller.item});
				...
				//TrainCraftingManager.instance.addRecipe(new ItemStack(TCBlocksList.stopper.block, 1), new Object[] { "WWW", "I I", "RRR", Character.valueOf('W'), s1.get(i), Character.valueOf('R'), Block.rail, Character.valueOf('I'), Item.ingotIron});// stopper
		...
		//TrainCraftingManager.instance.addRecipe(new ItemStack(ItemIDs.tcRailLargeSlopeBallast.item, 2), new Object[] {"  S", " SB","SBB", Character.valueOf('S'), ItemIDs.tcRailSmallStraight.item,Character.valueOf('B'), new ItemStack(TCBlocksList.oreTC.block, 1,3) });// straight slopes
		
		//TrainCraftingManager.instance.addRecipe(new ItemStack(TCBlocksList.bridgePillar.block, 4), new Object[] {"SSS", "S S","SSS", Character.valueOf('S'), Item.stick});// bridge pillar
		
		/* Smelting recipes */
		GameRegistry.addSmelting(TCBlocksList.oreTC.block, OreDictionary.getOres("ingotCopper").get(0), 0.7F);
	}
